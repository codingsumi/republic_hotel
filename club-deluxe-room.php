...
<body class="home3">
    ...
    <section class="breadcrumb-area" style="background:url('images/header-cdr.jpg'); background-size:cover">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb-area-content">
                        ...
                        <ul>
                            ...
                            <li class="active"><a href="#">Club Deluxe Room</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-8 col-12">
                    <div id="myCarousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <img src="images/cdr1.jpg" alt="Republic Hotel" style="width:100%;">
                            </div>
                            <div class="item">
                                <img src="images/cdr2.jpg" alt="Republic Hotel" style="width:100%;">
                            </div>

                            <div class="item">
                                <img src="images/cdr3.jpg" alt="Republic Hotel" style="width:100%;">
                            </div>
                    ...
                    <div class="about-wrap1">
                        <h2 class="mb-20">Club Deluxe Room</h2>
                        <h3 style="margin-bottom:10px;">Single Bedroom : <i class="fa fa-rupee"></i>4000/-</h3>
                        <h3 style="margin-bottom:10px;">Double Bedroom : <i class="fa fa-rupee"></i>4500/-</h3>
...
<!-- Mirrored from www.republichotel.in/club-deluxe-room by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Oct 2023 05:38:55 GMT -->
